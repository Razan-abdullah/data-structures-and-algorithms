...
const totalSumCSV = (str) => {
  ...
  // Solution code here...
  let a=str.split(",");
   let numbers=a.map(e=> +e);
  total= numbers.reduce(function (acc, cur,index,arr) {
    return acc + cur;
...
let b= a.filter (e=> ! vowels.includes(e) )
console.log(b);
let c="";
